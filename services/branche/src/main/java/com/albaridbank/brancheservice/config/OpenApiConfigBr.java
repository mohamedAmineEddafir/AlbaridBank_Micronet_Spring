package com.albaridbank.brancheservice.config;
                ...
                .components(new Components()
                        .addSecuritySchemes("bearer-key",
                                new SecurityScheme()
                                        ...
                                        .bearerFormat("JWT")))
                .info(new Info()
                        .title("AlbaridBank Agence API")
                        .description("API du microservice Branche pour la gestion des agences")
                        .version("1.0.0")
                        .contact(new Contact()
